...
* create or respond to an issue for on the [Github Repository](http://github.com/ruby-rdf/rack-linkeddata/issues)
* Fork and clone the repo:
  `git clone git@github.com:your-username/rack-linkeddata.git`
* Install bundle:
  `bundle install`
